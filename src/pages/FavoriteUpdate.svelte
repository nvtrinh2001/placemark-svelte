<script>
  ...
  onMount(async () => {
    ...
    locationImage = returnedValue.image;
  ...
  async function updateFavoriteHandler(e) {
    ...
    await placemarkService.updateLocationById($updatedLocationId.id, data);
    pop();
  ...
  <div class="modal is-active" style="z-index: 101;">
    ...
    >
      <header class="modal-card-head modal-header">
        <p class="modal-card-title modal-heading">Update your location</p>
      </header>
